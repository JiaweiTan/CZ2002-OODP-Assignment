...
public class Invoice {
	...
	{ 
		...
		serviceCharge = computeServiceCharge(originalPrice);
		GST = computeGST(originalPrice, serviceCharge);
		finalPrice = originalPrice + GST + serviceCharge;
		...
		Invoice invoice = new Invoice(invoiceID, paymentType, orderID,  originalPrice , finalPrice, serviceCharge, GST, dateTime);
