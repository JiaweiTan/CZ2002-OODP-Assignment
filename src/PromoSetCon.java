...
public class PromoSetCon {
	...
	private static ArrayList<PromoSetCon> List123;
	...
	public PromoSetCon(int PromoSetId,String name, ArrayList<Integer> itemId, double Price, String startDate, String endDate,
			int quota) {
